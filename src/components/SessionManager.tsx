...
export default function SessionManager({
  ...
  const handleLoadMock = () => {
    if (confirm('Apakah Anda ingin memuat 30 data responden FC Barcelona (Pablo Gavi, Pedri, Lamine Yamal, Messi, dll) ke dalam sesi ini? Data akan langsung tersinkronisasi di Cloud Firestore.')) {
